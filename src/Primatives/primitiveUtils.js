...
class IntersectPoints {
   readonly Intersect: Vector2d = null;
   readonly IntersectEnd: Vector2d = null;
...
export default class PrimitiveUtils {
   static FromTo(begin: Vector2d, end: Vector2d): Vector2d {
        return new Vector2d(end.X - begin.X, end.Y - begin.Y);
    }

   static OrthogonalLeft(v: Vector2d): Vector2d {
        return new Vector2d(-v.Y, v.X);
    }

   static OrthogonalRight(v: Vector2d): Vector2d {
        return new Vector2d(v.Y, -v.X);
    }

   static OrthogonalProjection(unitVector: Vector2d, vectorToProject: Vector2d): Vector2d {
   ...
   static BisectorNormalized(norm1: Vector2d, norm2: Vector2d): Vector2d {
   ...
   static IsPointOnRay(point: Vector2d, ray: LineParametric2d, epsilon: number): boolean {
   ...
   static IntersectRays2D(r1: LineParametric2d, r2: LineParametric2d): IntersectPoints {
        const s1p0 = r1.A;
   ...
   static IsClockwisePolygon(polygon: List<Vector2d>): boolean {
   ...
   static IsPointInsidePolygon(point: Vector2d, points: List<Vector2d>): boolean {
